...
use App\API\V1\Parsers\MachineGeneralTestParser as Parser;
use App\API\V1\Repositories\MachineGeneralTestRepository as Repository;
use App\API\V1\Transformers\MachineGeneralTestTransformer as Transformer;
use Doctrine\ORM\EntityManagerInterface;
use Illuminate\Support\Collection;
use Illuminate\Http\Request;

class MachineGeneralTestController extends APIController
{
