 ...
 */
class Photo extends \App\API\V1\Entities\Photo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'text', 'format', 'inspection', 'majorAssembly', 'subAssembly', 'machineGeneralTest', 'oilTest', 'wearTest', 'technician', 'domainExpert'];
        }
