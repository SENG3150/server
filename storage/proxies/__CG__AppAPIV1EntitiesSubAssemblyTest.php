 ...
 */
class SubAssemblyTest extends \App\API\V1\Entities\SubAssemblyTest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SubAssemblyTest $proxy) {
