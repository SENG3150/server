 ...
 */
class InspectionSubAssembly extends \App\API\V1\Entities\InspectionSubAssembly implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'inspection', 'majorAssembly', 'subAssembly', 'comments'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InspectionSubAssembly $proxy) {
