 ...
 */
class InspectionSchedule extends \App\API\V1\Entities\InspectionSchedule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'inspection', 'inspections', 'value', 'period', 'timeDeleted', 'deleted'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InspectionSchedule $proxy) {
