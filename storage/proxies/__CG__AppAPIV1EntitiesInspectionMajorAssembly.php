 ...
 */
class InspectionMajorAssembly extends \App\API\V1\Entities\InspectionMajorAssembly implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InspectionMajorAssembly $proxy) {
