 ...
 */
class Downtime extends \App\API\V1\Entities\Downtime implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'machine', 'systemName', 'downTimeHours', 'reason'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Downtime $proxy) {
    ...
    public function getDownTimeHours()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDownTimeHours', []);

        return parent::getDownTimeHours();
    }
    ...
    public function setDownTimeHours($downTimeHours)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDownTimeHours', [$downTimeHours]);

        return parent::setDownTimeHours($downTimeHours);
    }
