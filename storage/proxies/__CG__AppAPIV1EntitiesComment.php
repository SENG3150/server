 ...
 */
class Comment extends \App\API\V1\Entities\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'text', 'timeCommented', 'inspection', 'majorAssembly', 'subAssembly', 'machineGeneralTest', 'oilTest', 'wearTest', 'technician', 'domainExpert'];
        }
