 ...
 */
class MajorAssembly extends \App\API\V1\Entities\MajorAssembly implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'model', 'subAssemblies', 'timeDeleted', 'deleted'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MajorAssembly $proxy) {
    ...
    public function getSubAssemblies()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubAssemblies', []);

        return parent::getSubAssemblies();
    }
    ...
    public function setSubAssemblies($subAssemblies)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubAssemblies', [$subAssemblies]);

        return parent::setSubAssemblies($subAssemblies);
    }
