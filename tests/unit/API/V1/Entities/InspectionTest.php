...
class InspectionTest extends TestCase
{
	...
	public function testTimeCreated()
	{
		...
		$minute      = rand(0, 59);
		$second      = rand(0, 59);
		$timeCreated = Carbon::create($year, $month, $day, $hour, $minute, $second);
		$entity      = new Inspection();
	...
	public function testTimeSchedule()
	{
		...
		$minute        = rand(0, 59);
		$second        = rand(0, 59);
		$timeScheduled = Carbon::create($year, $month, $day, $hour, $minute, $second);
		$entity        = new Inspection();
	...
	public function testTimeStarted()
	{
		...
		$minute      = rand(0, 59);
		$second      = rand(0, 59);
		$timeStarted = Carbon::create($year, $month, $day, $hour, $minute, $second);
		$entity      = new Inspection();
	...
	public function testTimeCompleted()
	{
		...
		$minute        = rand(0, 59);
		$second        = rand(0, 59);
		$timeCompleted = Carbon::create($year, $month, $day, $hour, $minute, $second);
		$entity        = new Inspection();
